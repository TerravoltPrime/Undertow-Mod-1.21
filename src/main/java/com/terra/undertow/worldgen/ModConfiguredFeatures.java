...
public class ModConfiguredFeatures {
    ...
    public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> context) {
        ...
        List<OreConfiguration.TargetBlockState> targetList = List.of(
                OreConfiguration.target(stoneReplaceables, ModBlocks.SOIL.get().defaultBlockState()),
                OreConfiguration.target(dirtReplaceables, ModBlocks.SOIL.get().defaultBlockState())
        );
