...
public class ModSurfaceRules {
    ...
    private static final SurfaceRules.RuleSource MOD_STONE_BLOCK = makeStateRule(ModBlocks.UNDER_SOIL.get());
    ...
    public static SurfaceRules.RuleSource makeRules() {
        ...
        SurfaceRules.RuleSource myRules = SurfaceRules.ifTrue(
                SurfaceRules.isBiome(UndertowModBiomes.UNDERGROVE), SurfaceRules.ifTrue(SurfaceRules.ON_FLOOR, MOD_GRASS_BLOCK)
        );
        ...
        SurfaceRules.RuleSource modBiomeRules = SurfaceRules.sequence(
                SurfaceRules.sequence(SurfaceRules.ifTrue(SurfaceRules.isBiome(UndertowModBiomes.UNDERGROVE),
                        ...
                        SurfaceRules.ifTrue(SurfaceRules.isBiome(UndertowModBiomes.UNDERGROVE), MOD_STONE_BLOCK)
                ),
                grassSurface
        );
