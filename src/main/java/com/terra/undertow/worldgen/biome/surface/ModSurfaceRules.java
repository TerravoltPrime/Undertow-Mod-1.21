...
public class ModSurfaceRules {
    ...
    public static SurfaceRules.RuleSource makeRules() {
        ...
        SurfaceRules.RuleSource myRules = SurfaceRules.ifTrue(
                SurfaceRules.isBiome(ModBiomes.VOLCANIC_NEXUS), SurfaceRules.ifTrue(SurfaceRules.ON_FLOOR, MOD_GRASS_BLOCK)
        );
        ...
        SurfaceRules.RuleSource modBiomeRules = SurfaceRules.sequence(
                SurfaceRules.sequence(SurfaceRules.ifTrue(SurfaceRules.isBiome(ModBiomes.VOLCANIC_NEXUS),
                        ...
                        SurfaceRules.ifTrue(SurfaceRules.isBiome(ModBiomes.VOLCANIC_NEXUS), MOD_STONE_BLOCK)
                ),
                grassSurface
        );
